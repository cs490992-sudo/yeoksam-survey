  ...
  return <div className="app-layout">
    ...
    <aside id="sidebar" className={`sidebar ${open ? 'open' : ''}`}>
      ...
      <nav aria-label="주 메뉴" onClick={() => setOpen(false)}>
        <section><h2>조사 관리</h2><NavLink end className={link} to="/">대시보드</NavLink><NavLink end className={link} to="/admin/new">새 조사</NavLink><NavLink end className={link} to="/surveys">조사 목록</NavLink></section>
