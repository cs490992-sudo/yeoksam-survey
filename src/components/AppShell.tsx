  ...
  return <div className="app-layout">
    ...
    <aside id="sidebar" className={`sidebar ${open ? 'open' : ''}`}>
      ...
      <nav aria-label="주 메뉴" onClick={() => setOpen(false)}>
        ...
        <section><h2>기록 및 분석</h2><NavLink className={link} to="/records">기록·결과</NavLink></section>
        <section><h2>이용인 및 연동</h2><a href={attendanceUrl} target="_blank" rel="noopener noreferrer">출석 앱으로 이동 ↗</a><a href={votingUrl} target="_blank" rel="noopener noreferrer">투표 앱으로 이동 ↗</a></section>
      </nav>
