...
export interface QuestionDraft { id: string; domain: string; question_text: string; response_type: ResponseType; is_required: boolean; options: QuestionOptionDraft[]; image_path: string | null; image_file?: File | null; image_preview_url?: string | null }
...
export interface RunQuestion { id: string; domain: string | null; question_text: string; response_type: ResponseType; sort_order: number; is_required: boolean; image_path: string | null; image_url: string | null; options: { id: string; label: string; numeric_value: number | null }[] }
